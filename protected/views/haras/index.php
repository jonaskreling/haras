	...
	<div class="row">
		<div class="col-xs-12 col-md-4">
			...
			<div class="thumbnail venda">
	      		<img src="<?php echo $baseUrlImage.'oharas.jpg'; ?>" alt="" class="image-border-dashed" style="min-height:230px;overflow:hidden;">
	      	</div>
		...
		<div class="col-xs-12 col-md-4">
			<h2>MATRIZES</h2>
			<div class="thumbnail venda">
	      		<img src="<?php echo $baseUrlImage.'matrizes.jpg'; ?>" alt="" class="image-border-dashed" style="min-height:230px;overflow:hidden;">
	      	</div>
		...
		<div class="col-xs-12 col-md-4">
			<h2>VENDAS</h2>
			<div class="thumbnail venda">
	      		<img src="<?php echo $baseUrlImage.'vendas.jpg'; ?>" alt="" class="image-border-dashed" style="min-height:230px;overflow:hidden;">
	      	</div>
