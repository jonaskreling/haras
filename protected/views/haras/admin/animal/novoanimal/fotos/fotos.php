...
<div role="tabpanel" class="tab-pane" id="fotos">
	...
	<div class='row'>
		...
		<div class="col-xs-12 col-md-4 text-right">
			<button type='button' class='btn btn-primary icones' ng-click='tabShowAnimal("premiacao")'><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;&nbsp;Voltar</button>
			<button type='button' class='btn btn-success icones' ng-click='salvarAnimal()' ng-disabled="animal.isNotSave">
	...
	<br />
	<div class="row">
		<div class="col-xs-12 col-md-6 well" ng-repeat="foto in animal.imagens" style="background-color:rgba(255,255,255,0.8);">
			<div class="col-xs-12">
				<div class="col-md-2">
